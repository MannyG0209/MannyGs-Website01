  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-center">
        ...
        <p className="text-neutral-300 text-sm md:text-base mx-auto max-w-sm">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-neutral-400">
                <span className="font-kulim">{item.title}</span>
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-red-500 via-red-500 to-transparent from-[0%] via-[10%] rounded-full before:absolute before:inset-x-[-8px] before:top-0 before:h-32 before:bg-red-500/20 before:blur-sm before:content-['']"
          />
        </div>
      </div>
    </div>
